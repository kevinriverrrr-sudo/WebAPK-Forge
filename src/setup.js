 ...
 *
 * Key design: tools (r8.jar, android.jar, debug.keystore) are stored
 * in ~/.webapk-forge/tools/ — writable even after npm install -g.
 * Source files (templates, etc.) are read from the npm package dir.
 */
...
/**
 * Tools directory — always writable, survives reinstalls.
 * ~/.webapk-forge/tools/ contains: r8.jar, android.jar, debug.keystore
 */
function getToolsDir() {
    const dir = path.join(os.homedir(), '.webapk-forge', 'tools');
            ...
            mod.get(currentUrl, (res) => {
                ...
                res.on('data', (chunk) => {
                    ...
                    if (total > 0) {
                        ...
                        process.stdout.write(`\r  ▸ Скачивание... ${pct}% (${(downloaded / 1048576).toFixed(1)} / ${(total / 1048576).toFixed(1)} MB)`);
                    }
                });
                res.pipe(file);
                file.on('finish', () => {
...
async function checkEnvironment() {
    ...
    log(`Tools directory: ${toolsDir}`, 'info');

    // Check Termux
    if (!isTermux()) {
        log('Не Termux — сборка может не работать', 'warn');
    }
    ...
    if (!fs.existsSync(r8Path)) {
        issues.push('r8.jar не найден — запустите: webapk setup');
    } else {
        log(`r8.jar: ${(fs.statSync(r8Path).size / 1048576).toFixed(1)} MB`, 'ok');
    }
    ...
    if (!fs.existsSync(androidJar)) {
        ...
        log(`android.jar: ${(fs.statSync(androidJar).size / 1024).toFixed(0)} KB`, 'ok');
    }
...
async function setupEnvironment() {
    ...
    for (const pkg of termuxPkgs) {
        const checkCmd = pkg === 'openjdk-17' ? 'javac' : pkg;
        if (cmdExists(checkCmd)) {
    ...
    if (fs.existsSync(keystorePath)) {
        ...
        log('Генерация debug.keystore...', 'step');
        ...
        if (ksResult.ok) {
            ...
            log(`keytool: ${ksResult.stderr}`, 'err');
        }
    }
...
class Configuration {}
class DisplayMetrics { public int widthPixels; public int heightPixels; public float density; public int densityDpi; public float scaledDensity; public float xdpi; public float ydpi; }
class TypedArray { public String getString(int index) { return null; } public int getInt(int index, int defValue) { return defValue; } public boolean getBoolean(int index, boolean defValue) { return defValue; } public int getResourceId(int index, int defValue) { return defValue; } public void recycle() {} }
class TypedValue { public int type; public int data; public String string; public int resourceId; public static final int TYPE_NULL = 0; public static final int TYPE_STRING = 3; public static final int TYPE_FIRST_INT = 16; public static final int TYPE_INT_DEC = 17; }`,
...
'android/os/Parcelable.java': `package android.os;
public interface Parcelable { int describeContents(); void writeToParcel(Parcel dest, int flags); public static final int PARCELABLE_WRITE_RETURN_VALUE = 1; }
interface Creator<T> { T createFromParcel(Parcel source); T[] newArray(int size); }
class Parcel { public void writeInt(int val) {} public void writeString(String val) {} public void writeParcelable(Parcelable p, int flags) {} public void writeLong(long val) {} public void writeBoolean(boolean val) {} public void writeFloat(float val) {} public void writeByteArray(byte[] b) {} public int readInt() { return 0; } public String readString() { return null; } public long readLong() { return 0; } public boolean readBoolean() { return false; } public float readFloat() { return 0; } public byte[] createByteArray() { return null; } public Parcelable readParcelable(ClassLoader loader) { return null; } }`,
...
public class Build {
    ...
    public static class VERSION { public static final String SDK = "21"; public static final int SDK_INT = 21; public static final String RELEASE = "5.0"; public static final String INCREMENTAL = ""; public static final String CODENAME = "REL"; }
}`,
...
public class ViewGroup extends View {
    ...
    public static class LayoutParams { public int width; public int height; public LayoutParams(int width, int height) {} }
    public static class MarginLayoutParams extends LayoutParams { public int leftMargin, topMargin, rightMargin, bottomMargin; public MarginLayoutParams(int width, int height) { super(width, height); } }
}`,
...
public interface WindowManager extends android.view.ViewManager {
    public interface LayoutParams extends android.view.ViewGroup.LayoutParams {
        ...
        public int type; public int gravity; public float horizontalMargin; public float verticalMargin; public int x; public int y; public int windowAnimations;
    }
}
interface ViewManager { void addView(View view, ViewGroup.LayoutParams params); void updateViewLayout(View view, ViewGroup.LayoutParams params); void removeView(View view); }`,
...
'android/view/Menu.java': `package android.view;
...
'android/view/MenuItem.java': `package android.view;
...
'android/view/MenuInflater.java': `package android.view;
public class MenuInflater { public void inflate(int menuRes, Menu menu) {} }`,
...
'android/view/ContextThemeWrapper.java': `package android.view;
import android.content.Context;
...
public class Drawable {
    ...
    public void setColorFilter(Object cf) {}
...
'android/util/AttributeSet.java': `package android.util;
...
'android/widget/ProgressBar.java': `package android.widget;
import android.content.Context;
import android.util.AttributeSet;
...
'android/widget/RelativeLayout.java': `package android.widget;
import android.content.Context;
import android.util.AttributeSet;
import android.view.ViewGroup;
...
public class WebView extends View {
    ...
    public static class HitTestResult { public static final int UNKNOWN_TYPE = 0; public static final int ANCHOR_TYPE = 1; public static final int PHONE_TYPE = 2; public int getType() { return 0; } public String getExtra() { return null; } }
...
`,
'android/webkit/WebResourceRequest.java': `package android.webkit;
import android.net.Uri;
public interface WebResourceRequest { Uri getUrl(); boolean isForMainFrame(); boolean hasGesture(); String getMethod(); java.util.Map<String, String> getRequestHeaders(); }`,
'android/webkit/WebResourceResponse.java': `package android.webkit;
import java.io.InputStream;
public class WebResourceResponse { public WebResourceResponse(String mimeType, String encoding, InputStream data) {} public String getMimeType() { return null; } public String getEncoding() { return null; } public InputStream getData() { return null; } }`,
'android/webkit/WebResourceError.java': `package android.webkit;
public class WebResourceError { public int getErrorCode() { return 0; } public CharSequence getDescription() { return null; } }`,
'android/webkit/SslErrorHandler.java': `package android.webkit;
public class SslErrorHandler { public void proceed() {} public void cancel() {} }`,
...
'android/webkit/JsResult.java': `package android.webkit;
public class JsResult { public boolean getResult() { return false; } public void confirm() {} public void cancel() {} }`,
'android/webkit/JsPromptResult.java': `package android.webkit;
public class JsPromptResult extends JsResult { public String getStringResult() { return null; } public void confirm(String result) {} }`,
'android/webkit/DownloadListener.java': `package android.webkit;
public interface DownloadListener { void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength); }`,
'android/webkit/PermissionRequest.java': `package android.webkit;
...
'android/net/http/SslError.java': `package android.net.http;
...
public class R {
    public static final class attr { public static final int windowBackground = 0; public static final int windowNoTitle = 0; public static final int windowFullscreen = 0; }
    public static final class style { public static final int Theme = 0; public static final int Theme_NoTitleBar = 0; public static final int Theme_NoTitleBar_Fullscreen = 0; public static final int Theme_DeviceDefault = 0; public static final int Theme_DeviceDefault_NoActionBar = 0; }
    public static final class id { public static final int text1 = 16908308; }
    public static final class integer { public static final int config_shortAnimTime = 200; }
}`,
        };
...
module.exports = { setupEnvironment, checkEnvironment, getToolsDir, isTermux, getTermuxPrefix, run, getPackageRoot };
